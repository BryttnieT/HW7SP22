...
class rankine():
    def __init__(self, p_low=0.08, p_high=80, t_high=None, eff_turbine=0.95, name='Rankine Cycle'): #edited p_low, p_high
        '''
    ...
    def calc_efficiency(self):
        ...
        return self.state1.h, self.state2.h, self.state3.h, self.state4.h, self.turbine_work, self.pump_work, self.heat_added, self.efficiency    #edit
    ...
    def plot_cycle_TS(self):
        ...
        plt.show()
def main(): #edited eff_turbine, t_high
    rankine1= rankine(p_low=8,p_high=8000,t_high=None,eff_turbine=0.95, name='Rankine Cycle - Superheated at turbine inlet') #instantiate a rankine object to test it.
    #t_high is specified
