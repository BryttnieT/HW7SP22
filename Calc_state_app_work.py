import numpy as np
from Calc_state import Steam_SI as steam  # import any of your own classes as you wish  edited by me!!!!!!!
import sys
...
class main_window(QWidget, Ui_Form):
    def __init__(self):
        ...
        self.setWindowTitle("Steam Property Calculator")    # edit set the window title
        ...
        self.assign_widgets()  # connects signal and slots
        self.show()
    ...
    def Calculate(self):
        ...
        self.lbl_Properties.setText(state.region)  # edit set the text in each line edit and the label should tell the state 'saturated' or 'superheated'
        return
